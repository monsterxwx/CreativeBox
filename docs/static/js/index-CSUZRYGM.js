import{d as S,r as h,c as A,l as E,y as p,q as u,u as m,I as C,M,N as H,i as I,v as B}from"./@vue-Fm27AhWm.js";import{u as D,A as _,M as b}from"./useDeepSeek-Cmtsom88.js";import{M as R}from"./MarkdownEditor-DrzCEjiq.js";import{g as y}from"./marked-BrAPT9WN.js";import{_ as T}from"./plugin-vueexport-helper-DlAUqK2U.js";const g={tech:{wrapperStyle:"max-width: 650px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Helvetica Neue', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei UI', 'Microsoft YaHei', Arial, sans-serif; color: #333; line-height: 1.7; letter-spacing: 0.5px; padding: 15px; box-sizing: border-box;",h1:e=>`
...
</div>`),{isAILoading:t,showKeyModal:o,formatTextWithAI:l,saveApiKey:a}=D(),s=h(null),f=A(()=>N(i.value,n.value)),w=async(d="optimize")=>{if(t.value)return;const r=await l(i.value,d,"wechat");r&&(i.value=r)},k=async d=>{a(d);const r=await l(i.value,"optimize","wechat");r&&(i.value=r)},v=async()=>{if(s.value)try{const d=s.value.innerHTML;if(navigator.clipboard&&window.ClipboardItem){const $=new Blob([d],{type:"text/html"}),F=new Blob([s.value.innerText],{type:"text/plain"}),z=[new ClipboardItem({"text/html":$,"text/plain":F})];await navigator.clipboard.write(z),b.success("复制成功！快去公众号后台 Ctrl+V 粘贴吧~");return}const r=document.createElement("div");r.innerHTML=d,r.style.position="fixed",r.style.left="-9999px",document.body.appendChild(r);const c=document.createRange();c.selectNodeContents(r);const x=window.getSelection();x&&(x.removeAllRanges(),x.addRange(c),document.execCommand("copy"),x.removeAllRanges(),b.success("复制成功！快去公众号后台 Ctrl+V 粘贴吧~")),document.body.removeChild(r)}catch(d){console.error("复制失败:",d),b.error("复制失败，请尝试手动全选右侧预览区域进行复制。")}};return(d,r)=>(B(),E("div",q,[p("div",L,[r[4]||(r[4]=p("h2",null,"✍️ 公众号长文排版",-1)),r[5]||(r[5]=p("div",{class:"subtitle"},"在这里编写 Markdown，右侧实时预览公众号最终效果",-1)),u(R,{style:{flex:"1"},modelValue:i.value,"onUpdate:modelValue":r[0]||(r[0]=c=>i.value=c),isAILoading:m(t),onAiFormat:w,"hide-ai-optimize":""},null,8,["modelValue","isAILoading"]),p("div",U,[p("div",j,[C(p("select",{"onUpdate:modelValue":r[1]||(r[1]=c=>n.value=c)},[...r[3]||(r[3]=[H('<option value="tech" data-v-8252c505>💎 科技职场风格</option><option value="minimal" data-v-8252c505>🍏 苹果极简风格</option><option value="emotion" data-v-8252c505>💌 情感走心风格</option><option value="indigo" data-v-8252c505>📘 深度技术风格</option><option value="geek" data-v-8252c505>💻 极客开发风格</option>',5)])],512),[[M,n.value]])]),p("button",{class:"action-btn primary",onClick:v},"🔗 一键复制排版去公众号粘贴")])]),p("div",P,[p("div",W,[p("div",{class:"phone-content",ref_key:"previewRef",ref:s,innerHTML:f.value},null,8,G)])]),u(_,{modelValue:m(o),"onUpdate:modelValue":r[2]||(r[2]=c=>I(o)?o.value=c:null),onSave:k},null,8,["modelValue"])]))}}),Z=T(K,[["__scopeId","data-v-8252c505"]]);export{Z as default};
